...
import com.jzo2o.foundations.service.impl.ServeTypeServiceImpl;
...
//    @Resource
//    ServeServiceImpl serveTypeService;
//
//
//    @Test
//    void testPageHelper(){
...
//        PageResult<ServeResDTO> page = serveTypeService.page(servePageQueryReqDTO);
//        log.info("page : {}", page);
